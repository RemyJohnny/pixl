...
func (c *Canvas) LoadImage(img image.Image) {
	dimension := img.Bounds()

	c.CanvasConfig.PxCols = dimension.Dx()
	c.CanvasConfig.PxRows = dimension.Dy()
